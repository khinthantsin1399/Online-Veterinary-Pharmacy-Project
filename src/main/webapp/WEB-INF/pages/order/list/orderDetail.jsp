...
<body>
  <div class="wrapper" style="padding-bottom: 6%;">
    <div class="container">
      ...
      <div class="order-detail-sec clearfix">
        ...
        <table class="order-detail-tbl ">
          <tr>
            <th><label for="name" class="order-label">User
                Name</label></th>
            <td>${order.u_name}</td>
          </tr>
          <tr>
            <th><label for="phone" class="order-label">Phone
                No</label></th>
            <td>${order.u_phone}</td>
          </tr>
          <tr>
          ...
          <tr>
            <th><label for="date" class="order-label">Order
                Date</label></th>
          ...
          <tr>
            ...
            <c:if test="${order.status}">
              <td><span class="order-status">Ordered</span></td>
            </c:if>
            <c:if test="${!order.status && order.deleted_at == null}">
              <td><span class="order-status not-yet-status">Not
                  yet</span></td>
            </c:if>
      ...
      <div class="card border-0 mt-5 card-bg">
      ...
      <div class="text-center footer-btn mt-3 mb-3">
        <a
