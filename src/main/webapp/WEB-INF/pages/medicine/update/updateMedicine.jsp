...
<div class="wrapper">
 ...
 <c:url var="updateMedicine" value="/updateMedicineConfirm"></c:url>
            <form:form class="form" action="updateMedicineConfirm"
              method="POST" id="form" modelAttribute="medicine" enctype="multipart/form-data">
              <input type="hidden" name="id"
                value="${medicine.id }" />
				 ...
				 />
					...
					<form:select path="category.category_id" name="medicine.category.category_id">
  ...
  <c:forEach items="${CategoryList}" var="category">
					...
					<input name="amount" class="form-control" type="text" value="${medicine.amount}"
						 />
					...
					<label for="image">Image</label>
					 <input type="file" name="fileUpload"
                        ...
                        src="${medicine.image}" id="medicine_image"
                  ...
                  <a class="btn" href="${pageContext.request.contextPath}/medicineList">Back</a>
                  <a class="btn" href="${pageContext.request.contextPath}/updateMedicine?id=${medicine.id}">Reset</a>
