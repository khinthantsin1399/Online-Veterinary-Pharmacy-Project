...
<div class="wrapper">
  ...
  <c:url var="updateMedicineConfirm" value="/editMedicine"></c:url>
            <form:form class="form" action="editMedicine"
              method="POST" id="form" modelAttribute="updateMedicineForm">
                ...
                value="${updateMedicineForm.id }" />
                   ...
                   <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item"><b>Unit In Stock</b> <a
                      class="float-right">${updateMedicineForm.unit_in_stock}
                    ...
                    <li class="list-group-item"><b>Price</b> <a
                      class="float-right">${updateMedicineForm.amount}
                     ...
                     <li class="list-group-item"><b>Image</b> <a
                      class="float-right"><img
                        src="${updateMedicineForm.image}" id="medicine_image"
                        class="profile-user-img img-fluid img-circle" /><input
                        type="hidden" name="image"
                        value="${updateMedicineForm.image}"
