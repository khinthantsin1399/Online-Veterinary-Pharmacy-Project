...
<!-- NAVIGATION MENUS --> <c:choose>
        ...
        <ul class="nav-links">
          ...
          <div class="menu menu-hide">
            ...
            <li class="services"><a class="profileDropUserbtn"
              onclick="myProfileUserFunction()"><i
                class="fa-solid fa-user"></i> ${LOGIN_USER.username} <i
                class="fa fa-caret-down"></i></a> <!-- DROPDOWN MENU -->
              <ul class="dropdown-content" id="profileDropUserDown">
                <li><c:url
                    value="/profile/detail?id=${LOGIN_USER.id}"
        ...
        <ul class="nav-links">
          ...
          <div class="menu">
            ...
            <li class="services"><a class="dropbtn"
              onclick="myFunction()">Medicines <i
            ...
            <li class="services hide-hamburger"><a
              class="profileHideDropbtn"
              onclick="myProfileHideFunction()"><i
                class="fa-solid fa-user"></i> ${LOGIN_USER.username} <i
  ...
  <c:otherwise>
    ...
    <ul class="nav-profile">
      <div class="menu">
        <li class="services"><a class="profileDropbtn"
          onclick="myProfileFunction()"><i
            class="fa-solid fa-list-check"></i> Settings <i
            class="fa fa-caret-down"></i></a>
          <ul class="dropdown-content" id="profileDropDown">
            <li><c:url value="/login" var="login" /><a
...
</c:choose> <!-- <div class="menu">
  <li><a href="/">Home</a></li>
  <li><a href="/">Users</a></li>
  <li class="services"><a class="dropbtn" onclick="myFunction()">Medicines
  ...
  <li class="services hide-hamburger"><a class="profileHideDropbtn"
    onclick="myProfileHideFunction()"><i class="fa-solid fa-user"></i>
      Kyaw Htet <i class="fa fa-caret-down"></i></a>
    <ul class="dropdown-content" id="profileHideDropDown">
