		...
		<div class="container">
          ...
          <form:form method="post"
            ...
            modelAttribute="userConfirmForm" class="form clearfix">
              ...
              <label for="name">User Name</label> <span class="input"> ${ userConfirmForm.username }</span>
              ...
              <label for="email">Email :</label>  <span class="input">${ userConfirmForm.email }</span>
              <form:input type="hidden"  id="email"
           ...
           <span class="input">  PHARMACIST</span>
              ...
              <label for="phone">Phone No:</label>  <span class="input">${ userConfirmForm.phone }</span>
              <form:input type="hidden"  id="phone"
                placeholder="Enter phone no" name="phone" path="phone"
                value="${ userConfirmForm.phone }" />
       
              <label for="address">Address :</label> <span class="input"> ${ userConfirmForm.address }</span>
              <form:input type="hidden" 
